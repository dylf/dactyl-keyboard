...
class DefaultCluster(object):
    ...
    def thumborigin(self):
        ...
        origin = key_position([mount_width / 2, -(mount_height / 2), 0], 1, self.c_row)
    ...
    def thumb_connectors(self, side="right"):
        ...
        if default_1U_cluster:
            hulls.append(
                triangle_hulls(
                    [
                        self.tl_place(self.thumb_post_tl()),
                        key_place(web_post_bl(), 0, self.c_row),
                        self.tl_place(self.thumb_post_tr()),
                        key_place(web_post_bl(), 1, self.c_row),
                        self.tr_place(web_post_tl()),
                        key_place(web_post_bl(), 1, self.c_row),
                        self.tr_place(web_post_tr()),
                        key_place(web_post_br(), 1, self.c_row),
                        ...
                        # key_place(web_post_bl(), 3, self.c_row),
                        # key_place(web_post_tr(), 3, lastrow),
                        # key_place(web_post_br(), 3, self.c_row),
                        # key_place(web_post_bl(), 4, self.c_row),
                    ]
                )
            )
        else:
            hulls.append(
                triangle_hulls(
                    [
                        ...
                        key_place(web_post_bl(), 0, self.c_row),
                        self.tl_place(self.thumb_post_tr()),
                        key_place(web_post_br(), 0, self.c_row),
                        self.tr_place(self.thumb_post_tl()),
                        key_place(web_post_bl(), 1, self.c_row),
        ...
        #             key_place(web_post_br(), 1, self.c_row),
        #             key_place(web_post_tl(), 2, lastrow),
        #             key_place(web_post_bl(), 2, self.c_row),
        #             key_place(web_post_tr(), 2, lastrow),
        #             key_place(web_post_br(), 2, self.c_row),
        #             key_place(web_post_bl(), 3, self.c_row),
        #         ]
        #     )
        # )
    ...
    def connection(self, side='right'):
        ...
        shape = union([bottom_hull(
            [
                left_key_place(translate(web_post(), wall_locate2(-1, 0)), self.c_row, -1, low_corner=True, side=side),
                left_key_place(translate(web_post(), wall_locate3(-1, 0)), self.c_row, -1, low_corner=True, side=side),
        ...
        shape = union([shape,
                       hull_from_shapes(
                           [
                               left_key_place(translate(web_post(), wall_locate2(-1, 0)), self.c_row, -1,
                                              low_corner=True, side=side),
                               left_key_place(translate(web_post(), wall_locate3(-1, 0)), self.c_row, -1,
                                              low_corner=True, side=side),
                               self.ml_place(translate(web_post_tr(), wall_locate2(-0.3, 1))),
                               self.ml_place(translate(web_post_tr(), wall_locate3(-0.3, 1))),
                               self.tl_place(self.thumb_post_tl()),
        ...
        shape = union([shape, hull_from_shapes(
            [
                left_key_place(translate(web_post(), wall_locate1(-1, 0)), self.c_row, -1, low_corner=True, side=side),
                left_key_place(translate(web_post(), wall_locate2(-1, 0)), self.c_row, -1, low_corner=True, side=side),
                left_key_place(translate(web_post(), wall_locate3(-1, 0)), self.c_row, -1, low_corner=True, side=side),
                self.tl_place(self.thumb_post_tl()),
            ]
        ...
        shape = union([shape, hull_from_shapes(
            [
                left_key_place(web_post(), self.c_row, -1, low_corner=True, side=side),
                left_key_place(translate(web_post(), wall_locate1(-1, 0)), self.c_row, -1, low_corner=True, side=side),
                key_place(web_post_bl(), 0, self.c_row),
                self.tl_place(self.thumb_post_tl()),
            ]
